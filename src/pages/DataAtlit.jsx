        ...
        <tbody>
          {athletes.map((athlete, index) => (
            <tr key={index}>
              ...
              <td className='border px-4 py-2'><button onClick={openModal} className="flex items-center p-2 text-white bg-red-400 rounded-full shadow hover:text-gray-700 text-md">
