        ...
        <tbody className='bg-white divide-y divide-gray-200'>
          {coachs.map((coach, index) => (
            <tr key={index}>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{coach.nik}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{coach.nama}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{coach.alamat}</td>
