...
Lebih Lanjut
            ...
            <div className="mt-8">
              <Link
                to='/sambutan'
                className="inline-flex rounded-md bg-yellow-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Lebih lanjut
              </Link>
            </div>
