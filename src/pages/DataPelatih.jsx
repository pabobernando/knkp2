        ...
        <tbody>
          {pelatihs.map((pelatih, index) => (
            <tr key={index}>
              ...
              <td className="border px-4 py-2">{pelatih.nik}</td>
              <td className="border px-4 py-2">{pelatih.nama}</td>
              <td className="border px-4 py-2">{pelatih.alamat}</td>
              <td className="border px-4 py-2">{pelatih.ttl}</td>
              <td className="border px-4 py-2">{pelatih.telephone}</td>
              <td className="border px-4 py-2">{pelatih.gender}</td>
              <td className="border px-4 py-2">{pelatih.prestasi}</td>
              <td className="border px-4 py-2">{pelatih.keterangan}</td>
              <td className="border px-4 py-2">{pelatih.cabor.nama}</td>
