    ...
    <div className="flex items-start justify-between">
        ...
        <div className="flex flex-col w-full md:space-y-4">
            <div className="h-screen px-4 pb-24 overflow-auto md:px-6">
                ...
                <DropdownCabor onChange={(idCabor) => { 
  getDataAtlit({ cabor_id: idCabor });
  console.log("Cabor ", idCabor);
}} />
...
<button type="button" onClick={downloadFile} class="py-2 px-4 flex justify-center items-center  bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
...
<button type="button" onClick={openModalAdd} class="py-2 px-4 flex justify-center items-center  bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
        ...
        <tbody>
          {athletes.map((athlete, index) => (
            <tr key={index}>
              ...
              <td className="border px-4 py-2 bg-gray-200">{athlete.idCabor}</td>
              <td className='border px-4 py-2 bg-gray-200 flex '>
                <button onClick={() => {
                  setSelectedAthele(athlete)
                  openModalAdd()
                }} className="flex items-center p-2 text-white bg-red-300 rounded-full shadow hover:text-red-700 hover:bg-white text-md mx-4">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                        ...
                        </button><br /><button onClick={() => openModal(athlete)} className="flex items-center p-2 text-white bg-red-500 hover:text-white hover:bg-red-500 rounded-full shadow text-md">
                        <svg width="10" height="10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
