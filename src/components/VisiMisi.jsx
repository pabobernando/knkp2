...
function VisiMisi() {
  ...
  >
    <div className="mx-auto max-w-lg text-center">
      <h2 className="text-2xl font-bold sm:text-4xl">Visi</h2>

      <p className="mt-4 text-gray-300 text-md">
        Terwujudnya Prestasi Olahraga Kulon Progo yang unggul di Daerah dan Nasional
      </p>
    </div>
    <h2 className="text-2xl font-bold sm:text-4xl text-center mt-5">Misi</h2>
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-10 h-10 text-red-500">
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
        ...
        <h2 className="mt-4 text-md font-bold text-white">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
        ...
        <h2 className="mt-4 text-md font-bold text-white">Meningkatkan kesejahteraan perilaku olahraga yang berprestasi dan berdedikasi</h2>
      </div>
    </div>
  </div>
</section>
